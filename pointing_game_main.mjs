...
var TIME_LIMIT = 10;
var MAX_POINTS = 1000;
var GENERAL = ["Fruits", "Vegetables", "Foods", "How are you?", "Body Parts", "Colors", "Colorful Fruits", "ABC → ABC", "abc → ABC", "1-12", "1-20", "100-9900", "Weather", "Days", "Months", "Dates", "Digital Clock", "Stationery", "My Room", "Subjects", "Buildings", "Jobs", "Countries", "Opposites"];
...
var JUNIOR_SUNSHINE_5 = ["Months", "Dates", "Days", "Subjects", "Action Verbs", "Buildings", "My Room", "on in under by", "Countries", "Zodiac", "Foods", "Prices", "Famous Foods of Japan", "100-9900"];
