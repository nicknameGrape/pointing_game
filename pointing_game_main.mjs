...
var TIME_LIMIT = 10;
var MAX_POINTS = 1000;
var GENERAL = ["Fruits", "Vegetables", "Foods", "How are you?", "Body Parts", "Colors", "Colorful Fruits", "ABC → ABC", "abc → ABC", "1-12", "1-20", "100-9900", "Weather", "Days", "Months", "Dates", "Stationery", "My Room", "Subjects", "Buildings", "Jobs", "Countries", "Opposites"];
